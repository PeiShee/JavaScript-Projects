...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer ==='X') {
            ...
            select.style.backgroungImage = 'url("images/x.png")';
    ...
    function computersTurn() {
        ...
        let success = false;
        //Thisvariable stores a random number 0-8
        let pickASquare;
        //This condition allows our while leep to keep trying if a square is selected already.
        while(!success) {
            //A randam number between 0 and 8 is selected
    ...
    function checkWinConditions() {
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            //The next 3 vaiables will be used to check for 3 in a row. 
...
//This function makes our body eleent temporarily unclickable.
...
function audio(audioURL) {
    ...
    //Play methid plays our audio sound.
    audio.play();
}

//This function utilizes html canvas to draw win lines.
function drawWinLine(coordX1, coorY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a lines y axis is.
        y1 = coordY1,
    //This line indicates whee the end of a lines x axis is.
        x2 = coordX2,
...
function animateLineDrawing() { 
    ...
    if (x1 <= x2 && y1 <= y2) {
        ...
        if (y < y2) { y += 10; }
        //This condition cancels our animtion loop if reach the end points.
...
//This function resets the ga,e ina tie or a win.
function resetGame() {
    //Ghis for loop iterates through each HTML square element
    for (let i = 0; i < 9; i++) {
        //This variable gets the html element of 1.
        let square = document.getElementById(string(i));
        //This removes our elements backgroundImage.
        square.stylebackgroundImage = '';
    }
